...
def debate_with_speech(
    ...
    tts_callback1 = StreamingTTSCallback(voice="onyx", model="tts-1")  # Deeper voice for Socrates
    tts_callback2 = StreamingTTSCallback(voice="nova", model="tts-1")  # Softer voice for Simone
    ...
    if use_stt_for_input and task is None:
        ...
        audio = record_audio(duration=10.0)
        transcribed = speech_to_text(audio_data=audio, sample_rate=16000)
