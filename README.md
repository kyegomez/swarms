...
| **[Feedo Memory Network](https://feedo.ai)** | Decentralized E2EE memory network for autonomous agents. Gives agents permanent memory using zero-knowledge vector storage. | [Feedo Example](examples/tools/feedo/feedo_memory_example.py) |
