...
host = (
    shared.args.listen_host
    if shared.args.listen_host and shared.args.listen
    else "127.0.0.1"
)
...
def ui():
    ...
    try:
        ...
        logging.error(
            "===> ngrok library not found, please run `pip install -r extensions/ngrok/requirements.txt`"
        )
