...
def ui():
        ...
        with gr.Row():
            with gr.Accordion("Settings", open=False):
                auto_submit = gr.Checkbox(
                    label="Submit the transcribed audio automatically",
                    value=params["auto_submit"],
                )
    ...
    audio.change(
        auto_transcribe,
        [audio, auto_submit, whipser_model, whipser_language],
        [shared.gradio["textbox"], audio],
    ).then(
        None,
        auto_submit,
        None,
