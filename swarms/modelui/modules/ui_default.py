            ...
            with gr.Column():
                with gr.Row():
                    ...
                    shared.gradio["token-counter-default"] = gr.HTML(
                        value="<span>0</span>",
                        elem_classes=["token-counter", "default-token-counter"],
                    )
                ...
                with gr.Row():
                    ...
                    shared.gradio["save_prompt-default"] = gr.Button(
...
def create_event_handlers():
    shared.gradio["Generate-default"].click(
        lambda x: x, gradio("textbox-default"), gradio("last_input-default")
    ).then(
        ui.gather_interface_values,
        gradio(shared.input_elements),
        gradio("interface_state"),
    ).then(
        generate_reply_wrapper, gradio(inputs), gradio(outputs), show_progress=False
    ).then(
        ui.gather_interface_values,
        gradio(shared.input_elements),
        gradio("interface_state"),
    ...
    shared.gradio["Continue-default"].click(
        ...
        generate_reply_wrapper,
        [shared.gradio["output_textbox"]] + gradio(inputs)[1:],
        gradio(outputs),
        show_progress=False,
    ).then(
        ui.gather_interface_values,
    ...
    shared.gradio["delete_prompt-default"].click(
        ...
        lambda x: x + ".txt", gradio("prompt_menu-default"), gradio("delete_filename")
    ).then(
