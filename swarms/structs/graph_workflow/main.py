...
from swarms.structs.graph_workflow.backends import GraphBackend, NetworkXBackend, RustworkxBackend, RUSTWORKX_AVAILABLE
from swarms.structs.graph_workflow.visualization import visualize_workflow, visualize_workflow_simple
from swarms.structs.graph_workflow.persistence import to_topology_spec, from_topology_spec
...
class GraphWorkflow:
    ...
    def visualize(
        self, format: str = "png", view: bool = True, engine: str = "dot", show_summary: bool = False
    ) -> str:
        return visualize_workflow(self, format=format, view=view, engine=engine, show_summary=show_summary)

    def visualize_simple(self) -> str:
        return visualize_workflow_simple(self)
